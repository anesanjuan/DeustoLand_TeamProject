...
public class Admin extends User {
	...
	// tbala usuario con lo comun + columna tipo (boolean, string.. para
	...
	public Admin(String nombre, String apellido, String dni, String contrasena, String fechaUltimaMod) {

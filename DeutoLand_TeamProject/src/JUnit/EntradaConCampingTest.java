...
public class EntradaConCampingTest {
	...
	public void test() {
		...
		EntradaConCamping ec = new EntradaConCamping(new Cliente("Ramon", "Foronda", "3234570B", "ramonperales@gmail.com", "4567", "Blas de Otero, 15", 20, 12398), 200, new Festival(02, "Coachella", "25-04-2023", "Colorado, California, EEUU",

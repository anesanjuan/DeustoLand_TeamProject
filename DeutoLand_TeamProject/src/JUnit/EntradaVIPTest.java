...
public class EntradaVIPTest {
	...
	public void test() {
		...
		EntradaVIP ev = new EntradaVIP(new Cliente("Cristina", "Lopez", "4567881A", "crislopez@gmail.com", "5678", "Miguel de cervantes 10B", 20, 46573), 100, new Festival(01, "Tomorrowland", "21-07-2023", "Boom, Bélgica",

	...
	public VentanaRegistro(Gestor gestor) {
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(63)
					.addComponent(lblDNI, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
					.addGap(73)
					.addComponent(txtDNI, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(63)
					.addComponent(lblCorreo, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
					.addGap(73)
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(444)
					.addComponent(btnRegistro, GroupLayout.DEFAULT_SIZE, 89, Short.MAX_VALUE)
					.addGap(86))
				.addGroup(gl_panel.createSequentialGroup()
					.addGap(63)
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(txtEdad, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
					.addGap(6)
					.addComponent(btnRegistro, GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
					.addGap(5)
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(3)
